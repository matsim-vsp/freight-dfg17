...
//						CarrierService newService = null;
						 ...
						 * 
						 * DON'T DELETE! Although seemingly redundant, it is 
						 * used in experiments that cater for order frequency. */
						...
						if (shipment.getId().toString().equals( order.getId().toString()) ){		
//						if (service.getId().toString() == order.getId().toString()){		
